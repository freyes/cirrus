...
class InstanceContextMenu(Gtk.Menu):
    ...
    def show_menu(self):
        ...
        connect_menu.connect("activate", self.on_connect_menu_clicked)
    ...
    def create_connection_settings(self):
        ...
        self.view.connect("delete_event",
                          self.on_connection_settings_cancelled)
        ...
        self.connect_handler = self.connect_btn.connect(
            "clicked", self.on_connection_settings_ready)

        self.cancel_handler = self.cancel_btn.connect(
            "clicked", self.on_connection_settings_cancelled)

    def on_connect_menu_clicked(self, widget):
    ...
    def on_connection_tab_closed(self, tab_label, notebook, tab_widget):
        notebook.remove_page(notebook.page_num(tab_widget))

    def on_connection_settings_ready(self, widget):
        ...
        tab_label.connect("close-clicked", self.on_connection_tab_closed,
                          notebook,
                          terminal)

        notebook.append_page(terminal, tab_label)
        notebook.show_all()

        self.on_connection_settings_cancelled(self)

    def on_connection_settings_cancelled(self, widget):
        self.view.hide()
